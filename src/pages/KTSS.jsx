...
//import SelectionCard4 from '../components/Selection/SelectionCard4'
import SelectionCard5 from '../components/Selection/SelectionCard5'
...
const KTSS = () => {
  ...
  const fetchData = () => {
    ...
    return fetch("../../assets/data/kidney_data.json")
